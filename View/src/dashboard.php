...
<div class='container-fluid pt-4'>
    ...
    <div class="row">
        <div class="col-12 p-4">
            <div class="alert alert-info alert-dismissible fade show" id="hundred-alert" role="alert">
            ...
            <div class="card bg-light mb-3">
                <h4 class="card-header text-center" id="total-adherence">
                    Aderência total -
                    <svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-hourglass-split" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
