<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
    <a class="navbar-brand" href="../src/dashboard.php">Aderência Gre</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="../src/dashboard.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../src/checklist/casos_de_uso.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../src/checklist/especificacoes_requisitos">
            ...
            <li class="nav-item bg-red" id="btnExit">
...
<script type="text/javascript" src="../../Controller/js/menu.js"></script>